...
namespace ApiiOnline\Core\Console;

use Backpack\Settings\app\Models\Setting;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\Artisan;
use ApiiOnline\Core\Database\Seeders\CatalogsTableSeeder;
use ApiiOnline\Core\Database\Seeders\CategoriesTableSeeder;
use ApiiOnline\Core\Database\Seeders\MenusTableSeeder;
use ApiiOnline\Core\Database\Seeders\PermissionsSeeder;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'apiionline:install';
     ...
     * @var string
     */
    protected $description = 'Install ApiiOnline';
    ...
    public function handle()
    {
        ...
        $this->newLine(1);
        $this->info('ApiiOnline installation finished.');
