...
namespace ApiiOnline\Core\Controllers\Admin;

use ApiiOnline\Core\Requests\MovieRequest;
 ...
 * @package ApiiOnline\Core\Controllers\Admin
...
class MovieCrudController extends CrudController
{
    ...
    use \ApiiOnline\Core\Traits\Operations\BulkDeleteOperation {
    ...
    {
        CRUD::setModel(\ApiiOnline\Core\Models\Movie::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/movie');
        CRUD::setEntityNameStrings('movie', 'movies');
        CRUD::setCreateView('apiionline::movies.create',);
        CRUD::setUpdateView('apiionline::movies.edit',);
    }
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->addFilter([
            ...
            if ($field === 'language') {
                ...
                $this->crud->query->where($field, '')->orWhere($field, NULL)->orWhere($field, 'like', '%img.phimapi%')->orWhere($field, 'like', '%img.phimapi%');
            }
        });
        ...
        CRUD::addColumn([
            ...
            'label' => 'Thông tin',
            'type' => 'view',
            'view' => 'apiionline::movies.columns.column_movie_info',
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            'name' => 'episodes',
            'type' => 'view',
            'view' => 'apiionline::movies.inc.episode',
            'tab' => 'Danh sách tập phim'
        ],);

        CRUD::addField(['name' => 'update_handler', 'label' => 'Trình cập nhật', 'type' => 'select_from_array', 'options' => collect(config('apiionline.updaters', []))->pluck('name', 'handler')->toArray(), 'tab' => 'Cập nhật']);
