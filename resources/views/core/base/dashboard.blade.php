...
@php
    $widgets['before_content'] = [
        [
            ...
            'heading' => 'ApiiOnlineCMS - Mã nguồn xây dựng website phim miễn phí và vĩnh viễn.',
            'content' =>
                '
                Phiên bản: <span class="text-danger text-break">' .
                config('apiionline.version') .
                '</span><br/>
                Dữ liệu phim miễn phí: <a href="https://apiionline.vip">KKPHIM</a><br/>
                <b style="color:red;">Đây là mã nguồn được viết lại và tối ưu hóa dành riêng cho tài nguyên của KKPHIM.COM, mã nguồn gốc thuộc về Hacoidev - Phantom0803 cũng như nhóm Ophim. Chúng tôi luôn tôn trọng tác giả dưới mọi hình thức. Xin cảm ơn!</b>
            ',
